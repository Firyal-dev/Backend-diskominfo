...
{{-- Menambahkan judul dinamis untuk tab browser --}}
@section('title', 'Tambah Konten Baru')

@section('content')
    {{-- [DISEMPURNAKAN] Menambahkan struktur page-title untuk spacing yang benar --}}
    <div class="page-heading">
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Tambah Konten Baru</h3>
                    <p class="text-subtitle text-muted">Buat konten dinamis seperti berita atau pengumuman.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Formulir Konten</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
